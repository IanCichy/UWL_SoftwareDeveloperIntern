...
namespace FDS
{
    public class Equipment
    {
        ...
        /// </summary>
        /// <returns>
        /// Dictionary with pairs corresponding to (Condition description, Condition code)
        /// </returns>
        ...
        /// <returns>
        /// The newly created piece of equipment, null if equipment with name already exists in hall
        /// </returns>
        ...
        /// <summary>
        /// Checks in and out equipment in FDM3 1=in, 0=out
        /// </summary>
        ...
        {
            // create a command
            var statusChange = new SqlCommand("UPDATE Equipment SET status = @status, condition = @condition WHERE equipmentID=@equipmentID")
            {
                CommandType = CommandType.Text,
                Connection = Connections.FDSConnection()
            };
            statusChange.Parameters.Add(new SqlParameter("equipmentID", EquipmentID));
            statusChange.Parameters.Add(new SqlParameter("status", status));
            if (conditionIn.Equals("poor"))
            {
                statusChange.Parameters.Add(new SqlParameter("condition", "1"));
            }
            else if (conditionIn.Equals("damaged"))
            {
                statusChange.Parameters.Add(new SqlParameter("condition", "2"));
            }
            else
            {
                statusChange.Parameters.Add(new SqlParameter("condition", "0"));
            }
        ...
        /// <summary>
        /// Sets the name locally and in the database. If local name has not changed, database name
        /// did not change.
        /// </summary>
        ...
        /// <summary>
        /// Sets the Category locally and in the database. If local category has not changed,
        /// database category did not change.
        /// </summary>

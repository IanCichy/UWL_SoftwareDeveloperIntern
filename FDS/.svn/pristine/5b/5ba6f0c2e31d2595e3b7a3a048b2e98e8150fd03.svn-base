...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <form runat="server">
        ...
        <!---------------------GridView!---------------->
        <div class="gvPizza">
            <asp:GridView ID="gvPizzas" runat="server" AutoGenerateColumns="false" DataKeyNames="productID" AllowPaging="true" 
                AllowSorting="true" DataSourceID="sqlPizzas" OnRowCreated="gvPizzas_RowCreated" Width="750" OnRowUpdated="gvPizzas_RowUpdated">

...
public partial class Products : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sqlProduct.ConnectionString = FDS.Connections.FDSConnection().ConnectionString;
    ...
    {
        gvProducts.PageSize = int.Parse(((DropDownList)sender).SelectedValue);
        gvProducts.DataBind();
    }
    ...
    protected void btnExportProd_Click(object sender, EventArgs e)
    {
        ...
        Response.Clear();
        Response.AddHeader("content-disposition", "attachment;filename=ProductInventory.xls");
        Response.Charset = "";

...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <form id="Form1" runat="server">
        ...
        <div class="gvProducts">
            <asp:GridView ID="gvProducts" runat="server" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" DataSourceID="sqlProducts"
                 DataKeyNames="productID" BorderWidth="1px" OnRowCreated="gvProducts_RowCreated" Width="750" OnRowUpdated="gvProducts_RowUpdated">
            ...
            <!---------------------Inventory Changes!---------------->
            Inventory Changes
            <asp:GridView ID="gvProductInventory" runat="server" AutoGenerateColumns="false" Width="750"
                AllowPaging="true" AllowSorting="true" DataSourceID="sqlProduct">
                <PagerStyle CssClass="pager-row" />
                <EditRowStyle CssClass="edit-row" />
                <Columns>
            ...
            <asp:SqlDataSource ID="sqlProduct" runat="server" SelectCommandType="StoredProcedure" SelectCommand="ProductInventoryAdd">
                <SelectParameters>
                    <asp:SessionParameter Name="hallID" SessionField="hall" DefaultValue="-1" />
                </SelectParameters>
            </asp:SqlDataSource>
